import{r as B,l as d,u as m,a as L,b as y}from"./assets/api-8cdac80a.js";import"./assets/vendor-8dea2054.js";const S="/CrazySuperStars/assets/symbol-defs-39e2c5b5.svg",r=document.querySelector(".cart-list"),$=document.querySelector(".cart-empty-container"),s=document.querySelector(".pagination-list"),w=document.querySelector(".cart-buttons-container");B(".shoppinglist-title","Shopping List");function a(t){r.innerHTML="";const o=t.map(e=>`<li class="cart-item">
      <img
        class="cart-item-img"
        src="${e.book_image}"
        alt="book image"
