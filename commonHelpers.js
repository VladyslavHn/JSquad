import{r as k,l as d,a as B,b as L}from"./assets/api-5311b915.js";import"./assets/vendor-8dea2054.js";const y="/CrazySuperStars/assets/symbol-defs-39e2c5b5.svg",r=document.querySelector(".cart-list"),S=document.querySelector(".cart-empty-container"),s=document.querySelector(".pagination-list"),$=document.querySelector(".cart-buttons-container");k(".shoppinglist-title","Shopping List");function a(t){r.innerHTML="";const o=t.map(e=>`<li class="cart-item">
      <img
        class="cart-item-img"
        src="${e.book_image}"
        alt="book image"
