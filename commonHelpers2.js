import{b as r}from"./assets/api-68a386af.js";import"./assets/vendor-0cb09735.js";const i=async()=>{const e=document.querySelector(".best-books");try{const s=(await r.getBestSellers()).map(({books:o,list_name:l})=>`<li class="bestsellers-item">${l}
